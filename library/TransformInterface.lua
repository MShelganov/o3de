...
---Interface for TransformBus, which is an EBus that receives requests to translate (position), rotate, and scale an entity in 3D space. It also receives requests to get and set the parent of an entity and get the descendants of an entity.
...
function TransformInterface:GetAllDescendants() end
...
function TransformInterface:GetChildren() end
...
function TransformInterface:GetEntityAndAllDescendants() end

---Retrieves the entity's local and world transforms.
---@param localTM Transform
---@param worldTM Transform
function TransformInterface:GetLocalAndWorld(localTM, worldTM) end
...
function TransformInterface:GetLocalRotation() end

---Get the quaternion representing the local rotation.
---@return Quaternion # The rotation quaternion in local space.
function TransformInterface:GetLocalRotationQuaternion() end

---Scale modifiers
---@return Vector3 # The scale value in local space.
function TransformInterface:GetLocalScale() end
...
function TransformInterface:GetParent() end
...
function TransformInterface:GetParentId() end
...
function TransformInterface:GetWorldRotation() end

---Get the quaternion representing the world rotation.
---@return Quaternion # The Rotation quaternion in world space.
function TransformInterface:GetWorldRotationQuaternion() end
...
function TransformInterface:IsStaticTransform() end
...
function TransformInterface:MoveEntity(offset) end
...
function TransformInterface:NotifyChildChangedEvent(changeType, entityId) end
...
function TransformInterface:RotateAroundLocalX(eulerRadianAngle) end
...
function TransformInterface:RotateAroundLocalY(eulerRadianAngle) end
...
function TransformInterface:RotateAroundLocalZ(eulerRadianAngle) end
...
function TransformInterface:SetIsStaticTransform(isStatic) end
...
function TransformInterface:SetLocalRotation(eulerRadianAngles) end
...
function TransformInterface:SetLocalRotationQuaternion(quaternion) end
...
function TransformInterface:SetLocalTM(tm) end
...
function TransformInterface:SetParent(id) end
...
---@param id EntityId The ID of the entity to set as the parent.
function TransformInterface:SetParentRelative(id) end
...
function TransformInterface:SetWorldRotation(eulerRadianAngles) end
...
function TransformInterface:SetWorldRotationQuaternion(quaternion) end
